  ...
  template: `
    <div class="projects-page">
      ...
      <div class="content">
        ...
        <!-- Empty State -->
        <div class="empty-state" *ngIf="!isLoading() && campaigns().length === 0">
        ...
        <!-- Projects Grid -->
        <div class="projects-grid" *ngIf="!isLoading() && campaigns().length > 0">
          <a [routerLink]="['/projects', campaign.id]" class="project-card" *ngFor="let campaign of campaigns()">
